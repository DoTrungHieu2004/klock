...
- [ ] Standard analog clock with custom hands
- [ ] Custom time engine with multiple interpolation modes
- [ ] Smooth hand animations with custom easing
- [ ] Extensible architecture for clock variants
...
```
app/
├── src/main/java/com/hieu10/klock/
